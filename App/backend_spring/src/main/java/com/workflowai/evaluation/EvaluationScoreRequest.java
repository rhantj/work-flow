 ...
 * score/totalScore/contributionPublic/finalPublic/commentPublic/reviewerScore/grade/comment는
 ...
 * score(AI 기여 점수)와 totalScore(학점 계산기 최종 총합)는 별개 필드다 — 학점
 * 계산기 저장은 반드시 totalScore만 채우고 score는 건드리지 않아야 한다.
 */
