                ...
                {CONTRIB_REPORTS.map(r => (
                  <div key={r.memberId} className="bg-card rounded-xl border border-border shadow-sm overflow-hidden">
                    ...
                    <div className="px-5 py-3 space-y-2">
                      {Object.entries({ "업무 수행":r.categories.task, "회의 참여":r.categories.meeting, "문서 기여":r.categories.docs, "개발 기여":r.categories.dev, "협업 활동":r.categories.collab }).map(([label, val]) => (
